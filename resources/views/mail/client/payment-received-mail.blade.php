        ...
        <div class="sm:w-11/12 lg:w-3/4 mx-auto">
            <div class="flex flex-col p-4 sm:p-10 bg-white shadow-md rounded-xl dark:bg-gray-800">
                <div class="flex justify-between">
                    ...
                    <div class="text-end">
                        <h2 class="text-2xl md:text-3xl font-semibold text-gray-800 dark:text-gray-200">Receipt
                            # {{ $order->id }}</h2>
                ...
                <div class="mt-8 grid sm:grid-cols-2 gap-3">
                    <div class="mt-8 sm:mt-12">
                        <h4 class="text-lg font-semibold text-gray-800 dark:text-gray-200">Payment Received!</h4>
                        <h4 class="text-lg font-semibold text-gray-800 dark:text-gray-200">Order information bellow: </h4>
                    </div>
                    <!-- Col -->
                    <div class="sm:text-end space-y-2">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-1 gap-3 sm:gap-2">
                            <dl class="grid sm:grid-cols-5 gap-x-3">
                                <dt class="col-span-3 font-semibold text-gray-800 dark:text-gray-200">Payment date:</dt>
