            ...
            <div x-on:click="open" class="w-full">
                <div class="my-2 p-1 flex border border-gray-200 bg-white rounded">
                    <div class="flex flex-auto flex-wrap">
                        <template x-for="(option,index) in selected" :key="options.data[option].id">
                            <div class="flex justify-center items-center  font-medium py-1 px-1 bg-white rounded bg-gray-100 border">
                                <div class="text-xs font-normal leading-none max-w-full flex-initial"
                                     x-model="options.data[option]"
                                     x-text="options.data[option].name">
                                </div>
            ...
            <div class="w-full px-4">
                <div x-show.transition.origin.top="isOpen()"
                    ...
                    <div class="flex flex-col w-full overflow-y-auto h-64">
                        <template x-for="(option,index) in options.data"
                                  :key="option.id" class="overflow-auto">
