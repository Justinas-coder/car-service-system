    ...
    <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
        <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            <form @submit.prevent="submitForm">
                <div x-on:click.outside="openCreateModal = false"
                    ...
                    <div class="flex-1 sm:items-start">
                        <div>
                            <h3 class="text-base font-semibold leading-6 text-gray-900">Add New Model</h3>
                        </div>
                        <div>
                            <input type="text"
                                   name="vehicleModel"
                    ...
                    <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse justify-center">
                        ...
                        <button x-on:click="openCreateModal = false"
                                type="button"
